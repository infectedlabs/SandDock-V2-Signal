...
secondary_keywords: zignaly review, zignaly copy trading, profit sharing model crypto
...
## What is Zignaly and how does copy trading work?
...
| Feature | Zignaly | Sanddock |
| :--- | :--- | :--- |
| **Pricing Model** | Profit sharing / Performance fee (15% to 30%) | Flat monthly subscription (Free tier available) |
| **Custody of Funds** | Delegated to a manager's trading pool | Retained entirely by you on your exchange |
| **Execution Control** | Automated by the pool manager | Manual by you after reviewing the signal |
| **Incentive Structure** | High-risk upside for manager, high-risk downside for you | Focus on long-term subscriber retention & consistent alerts |
| **Setup Process** | Depositing into pools, selecting managers | Viewing alerts on Telegram/dashboard and trading |
| **Profit Retention** | You lose up to 30% of profits to the manager | You keep 100% of all profits |

## Frequently asked questions

**Is Zignaly free?**
Zignaly is free to sign up, but it is not free to use. You pay a performance fee (typically 15% to 30% of your profits) to the managers of the trading pools you join.

**What is a high-water mark in copy trading?**
A high-water mark is the highest value a trading account has reached. Performance fees can only be charged on new profits made above this historical peak, preventing managers from charging fees on recovered losses.

**What are the risks of profit-sharing copy trading?**
The primary risk is that pool managers are incentivized to take excessive risks, such as high leverage, because they profit from the upside but do not lose money when your capital is liquidated.

**Why choose Sanddock over Zignaly?**
Sanddock is safer because you keep 100% of your profits, retain complete custody and execution control over your account, and avoid the risky incentives of third-party pool managers.
  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is Zignaly free?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Zignaly has no upfront monthly cost, but charges a performance fee (usually 15-30%) on your trading profits, paid to the pool managers."
          }
        },
        {
          "@type": "Question",
          "name": "What is a high-water mark in copy trading?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A high-water mark is the peak value of your portfolio. The system ensures you only pay profit-sharing fees on profits that exceed this previous peak."
          }
        },
        {
          "@type": "Question",
          "name": "What are the risks of profit-sharing copy trading?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "It creates a moral hazard where managers may trade aggressively with high leverage, as they capture upside profits while you bear the downside losses."
          }
        },
        {
          "@type": "Question",
          "name": "Why choose Sanddock over Zignaly?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sanddock uses a flat subscription model, letting you keep 100% of your profits and execute trades manually with complete control over your own risk."
          }
        }
      ]
    }
