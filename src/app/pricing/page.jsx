...
const PLANS_DATA = {
  free: {
    ...
    highlight: false,
    features: [
      { text: "BTC/USDT signals - 30m timeframe", available: true },
      ...
      { text: "Automated Stop Loss & Take Profit levels", available: false },
      { text: "P&L dashboard", available: false },
      { text: "CSV export", available: false },
    ],
  },
  pro: {
    label: "Pro",
    ...
    highlight: true,
    features: [
      { text: "BTC + ETH + BNB signals - 30m timeframe", available: true },
      { text: "Automated Stop Loss & Take Profit levels", available: true },
      { text: "Added to Pro Telegram channel (all 3 coins)", available: true },
      ...
      { text: "Custom coin picker", available: false },
      { text: "Position sizing calculator", available: false },
    ],
  },
  master: {
    label: "Master",
    sublabel: "For power traders & quants",
    color: "text-[#c4b5fd]",
    badge: "Personalized",
    highlight: false,
    features: [
      { text: "Everything in Pro (BTC + ETH + BNB - 30m)", available: true },
      { text: "Choose 5 custom coins - direct bot alerts", available: true },
      { text: "Automated SL & TP on all 8 coins", available: true },
      { text: "Full P&L history & CSV export across all coins", available: true },
      { text: "Custom coin picker", available: true },
      { text: "Position sizing calculator", available: true },
      { text: "Weekly portfolio digest", available: true },
      { text: "Read-only API endpoint for integrations", available: true },
      { text: "Priority 6h email support", available: true },
    ],
  },
};
...
const COMPARISON_ROWS = [
  ["Coins", "BTC only", "BTC, ETH, BNB", "BTC, ETH, BNB + 5 coins of your choice"],
  ["Timeframe", "30m", "30m", "30m"],
  ["SL & TP Levels", "Locked", "Visible", "Visible"],
  ["P&L Dashboard", "No", "Full history", "Full history (all 8 coins)"],
  ["CSV Export", "No", "Yes", "Yes"],
  ["Signal Delivery", "Free Telegram group", "Pro Telegram channel", "Pro channel (main 3) + direct bot alerts (your 5)"],
  ["Custom Coin Picker", "No", "No", "Yes"],
  ["Position Sizing Calculator", "No", "No", "Yes"],
  ["Weekly Portfolio Digest", "No", "No", "Yes"],
  ["Read-Only API", "No", "No", "Yes"],
  ["Email Support", "48h", "12h priority", "6h priority"],
];
...
const PRICING_FAQ = [
  ...
  {
    q: "Why USDT only?",
    a: "USDT TRC-20 has near-zero fees, instant confirmation, and no price volatility. We avoid volatile assets to simplify accounting nightmares when BTC drops 20% after you pay.",
  },
];
