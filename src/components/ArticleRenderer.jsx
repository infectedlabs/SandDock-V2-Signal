      ...
      <section className="border-b border-black bg-zinc-50 py-12 md:py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#ff5722] mb-4">
            ...
            <span>/</span>
            <span className="text-zinc-500 font-medium truncate max-w-[200px] md:max-w-none">{frontmatter.title}</span>
          </div>
          ...
          <p className="mt-6 text-lg md:text-xl text-zinc-600 max-w-3xl font-medium leading-relaxed">
            {frontmatter.meta_description}
          </p>

          <div className="mt-8 flex flex-wrap items-center gap-y-4 gap-x-8 text-xs font-mono text-zinc-500 border-t border-zinc-200 pt-6">
            <div>
              <span className="uppercase text-zinc-400">Written by:</span>
              <span className="ml-2 font-bold text-black">{frontmatter.author || 'Sanddock Research Team'}</span>
            </div>
            <div>
              <span className="uppercase text-zinc-400">Last updated:</span>
              <span className="ml-2 font-bold text-black">{formatDate(frontmatter.last_updated)}</span>
            </div>
            {frontmatter.target_keyword && (
              <div>
                <span className="uppercase text-zinc-400">Topic Focus:</span>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative">
          ...
          <aside className="lg:col-span-3 order-2 lg:order-1">
            <div className="sticky top-24 border border-black p-6 rounded-lg bg-zinc-50">
              ...
              {headings.length > 0 ? (
                ...
                <p className="text-zinc-400 text-xs italic">No sections found in this article.</p>
              )}
            </div>
          </aside>
          ...
          <article className="lg:col-span-6 order-1 lg:order-2">
            ...
            <div className="mt-16 p-6 border border-zinc-200 rounded-lg bg-zinc-50 text-xs text-zinc-500 space-y-2 leading-relaxed">
          ...
          <aside className="lg:col-span-3 order-3">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="border border-black p-6 rounded-lg bg-white relative overflow-hidden group hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
                ...
                <div className="space-y-3 font-mono text-[11px] text-zinc-500 mb-6 bg-zinc-50 p-3 rounded border border-zinc-200">
              ...
              <div className="border border-zinc-200 p-5 rounded-lg bg-zinc-50/50 text-xs text-zinc-600 space-y-3">
