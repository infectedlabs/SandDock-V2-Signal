#!/usr/bin/env node
/**
 * WORKING BACKFILL - Parallel individual updates
 * Fixed: Only updates close fields, preserves symbol and other data
 */
...
async function bulkUpdateParallel(updates) {
  ...
  let updated = 0;
  let failed = 0;
  const PARALLEL = 100; // 100 parallel updates
